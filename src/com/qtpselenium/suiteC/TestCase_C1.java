...
public class TestCase_C1 extends TestSuieBase {
	...
	runmmodes = TestUtil.getDataSetRunmodes(suiteCxls, this.getClass().getSimpleName());
		
	}

	@Test(dataProvider = "getTestData")
	
	public void testcseC1(String Col1,
			String Col2,
			String Col3,
			String Col4){
		...
		APP_LOGS.debug("Executing Test case testcaseB2");
